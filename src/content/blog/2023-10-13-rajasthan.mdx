...
Beginning of this year, as soon as the school calendar was out, I eagerly awaited my birthday, the big 50th one, which happened to fall on a weekend. My initial instinct pointed me towards Goa, an evergreen destination to relax and unwind. However, Pamela, had a different idea – to finally tick off Andaman from our decade-long bucket list. I instantly loved the idea 
. <Icon name="phosphor/heart" class="text-xl text-red-700 inline-flex"/>


### Booking Battles

Discovering that [Club Mahindra](https://holidays.clubmahindra.com/) have resorts in Andaman, which we could access through our membership, got us excited. But, the challenge was that bookings opened four months in advance. Unfortunately, I missed the auspicious day, and when we finally tried, everything seemed booked and waitlisted, dampening our spirits. Despite this, I made some bookings, hoping for a turnaround.
