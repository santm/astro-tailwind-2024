...
coverAlt: ''
description: 'Some tech glitches'
pubDate: 2005-09-29
tags:
- picture
- tech notes
...
Top most Document root.  put this file in the same directory "gallery-2.0-full.tar.gz" make sure
binary mode also FTP this php file foobar.php with these lines in it  
````
...
Need to create the g2data directory and chmod 777 via ftp again to finish the same Gallery will ask you chmod 755 gallery2 directory.